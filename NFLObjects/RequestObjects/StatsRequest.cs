...
namespace NFLRequests
{
    public class StatsRequest
    {
        ...
        public StatsRequest(Game game = null, List<Fumble> fumbles = null, List<KickingStat> kickingStats = null, List<KickReturnStat> kickReturnStats = null,
